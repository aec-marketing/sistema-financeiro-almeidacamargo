...
export default function Dashboard({ user }: DashboardProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* KPIs Cards */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/50 p-6 border-l-4 border-blue-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{kpis.totalVendas.toLocaleString('pt-BR')}</p>
            </div>
          </div>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/50 p-6 border-l-4 border-green-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatarMoeda(kpis.faturamentoTotal)}</p>
            </div>
          </div>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/50 p-6 border-l-4 border-purple-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatarMoeda(kpis.ticketMedio)}</p>
            </div>
          </div>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900/50 p-6 border-l-4 border-orange-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Clientes Únicos</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{kpis.clientesUnicos}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              {vendasRecentes.length > 0 ? vendasRecentes.map((venda) => (
                <div key={venda.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center py-8">Nenhuma venda encontrada</p>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              {topProdutos.length > 0 ? topProdutos.map((item, index) => (
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center py-8">Nenhum produto encontrado</p>
              )}
            </div>
          </div>
        </div>
