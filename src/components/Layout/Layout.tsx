        ...
        <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              <div className="h-8 w-8 bg-blue-600 rounded-lg mr-3 flex items-center justify-center">
              ...
              <div>
                <h1 className="text-lg font-semibold text-gray-900">Sistema Financeiro</h1>
                <p className="text-xs text-blue-600 font-medium">Almeida&Camargo</p>
              </div>
            </div>
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            ...
            <div className="ml-3 flex-1">
              ...
              <p className={`text-xs truncate ${
                user.role === 'admin_financeiro' ? 'text-blue-600' : 'text-green-600'
              }`}>
            ...
            <button
  onClick={onLogout}
  className="p-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded flex-shrink-0"
  title="Sair"
>
