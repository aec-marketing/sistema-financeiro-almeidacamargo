  ...
  return (
    <div className="h-full flex flex-col p-8">
      ...
      {alcam && (
        <div className="mb-6">
          <div
            className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow-lg dark:shadow-gray-900/50 p-6"
          >
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="col-span-1">
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">Grupo Almeida & Camargo</p>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Total Ano</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Mês Atual</span>
                  </div>
              ...
              <div className="col-span-2 border-l-2 border-orange-300 pl-6">
                <h4 className="text-lg font-bold text-gray-700 dark:text-gray-200 mb-4">Composição do Grupo:</h4>
                <div className="grid grid-cols-2 gap-4">
                  {alcam.submarcas && alcam.submarcas.length > 0 ? (
                    ...
                    <div className="col-span-2 text-center text-gray-600 dark:text-gray-300 py-4">
      ...
      <div className="flex-1 grid grid-cols-3 gap-6">
        {outrasMarcas.map((marca) => (
            <div
              key={marca.nome}
              className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/50 p-6 flex flex-col"
            >
              {/* Nome da Marca */}
              <div className="text-center mb-4">
              ...
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-semibold text-gray-600 dark:text-gray-300">Total Ano</span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-semibold text-gray-600 dark:text-gray-300">Mês Atual</span>
                </div>
